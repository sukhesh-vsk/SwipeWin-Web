...
export const BottomBar: React.FC = () => {
  ...
  return (
    <footer className="flex absolute container-fluid bottom-1 w-full justify-around items-center">
      <div className="bg-text flex justify-around items-center w-full px-6 py-3 rounded-full ">
        <Link
          href="/events"
