...
import { AzuroSDKProvider, ChainId, ChainProvider, LiveProvider } from '@azuro-org/sdk'
...
export function Providers(props: ProvidersProps) {
  ...
  return (
    <WagmiProvider config={wagmiConfig}>
      ...
      <RainbowKitProvider>
      <AzuroSDKProvider initialChainId={initialChainId} initialLiveState={initialLiveState}>
        <ChainProvider initialChainId={initialChainId as unknown as ChainId}>
